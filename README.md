...
├── notebooks/              # Jupyter Notebook для анализа данных
│   └── EDA.ipynb           # Исследовательский анализ данных
└── src/                    # Подключение к БД и создание таблицы
    └── write_to_db.py      # Скрипт для записи данных в базу
```
...
#### notebooks/
Папка для Jupyter Notebook. Основные элементы:
- `EDA.ipynb`: Исследовательский анализ данных (Exploratory Data Analysis).

#### src/
Подключение к БД и создание таблицы. Основные элементы:
- `write_to_db.py`: Скрипт для записи данных в базу.
